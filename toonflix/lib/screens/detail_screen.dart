...
class _DetailScreenState extends State<DetailScreen> {
  ...
  late Future<WebtoonDetailModel> detailWebtoon;
  ...
  void initState() {
    super.initState();
    detailWebtoon = ApiService.getToonById(widget.webtoon.id);
                    ...
                    return Column(
                      children: [
                        for (var episode in snapshot.data!)
                          EpisodeWidget(
                              episode: episode, webtoon_id: widget.webtoon.id)
                      ],
                    );
                  }
                  return Container();
